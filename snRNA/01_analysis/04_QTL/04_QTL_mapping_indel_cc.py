...
# indels
plink_prefix_path = '/staging/leuven/stg_00090/ASA/analysis/2024_T2T_rna/01_analysis/plink/WGS_chm13.indels_only'
...
for file in all_files:
    ...
    covariates_file = f'/cc/ct/covariates/indel/{name}_cov.txt'
    prefix = f'cc/ct/parquets/indel/{name}'
    output_file = f'cc/ct/results/indel/eQTL_{name}.csv.gz'
